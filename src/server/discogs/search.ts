...
export const GET: APIRoute = async ({ url }) => {
  try {
    ...
    const type = url.searchParams.get('type') as 'release' | 'master' | 'artist' | 'label' | undefined;
    ...
    const response = {
      ...
      pagination: {
        ...
        has_next: searchResponse.pagination.page < searchResponse.pagination.pages,
        has_prev: searchResponse.pagination.page > 1,
        next_page: searchResponse.pagination.page < searchResponse.pagination.pages 
          ? searchResponse.pagination.page + 1 
          : null,
        prev_page: searchResponse.pagination.page > 1 
          ? searchResponse.pagination.page - 1 
          : null,
      },
...
export const POST: APIRoute = async ({ request }) => {
  try {
    ...
    console.error('Erreur lors de la récupération des détails de release:', error);
