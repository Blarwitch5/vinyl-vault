  ...
  vite: {
    plugins: [
      VitePWA({
        ...
        includeAssets: ['favicon.svg', 'default-avatar.svg', 'default-vinyl-cover.svg'],
        manifest: {
          name: 'VinylVault - Gestionnaire de Collection Vinyle',
          short_name: 'VinylVault',
          description: 'Gérez votre collection de vinyles avec VinylVault. Recherchez, organisez et suivez vos disques préférés.',
          theme_color: '#059669',
